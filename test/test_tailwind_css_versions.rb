...
class TestTailwindCSSVersions < Minitest::Test
  ...
  def test_tailwind_4_0_features
    ...
    assert_equal("bg-conic-10", @merger.merge("bg-conic bg-conic-10"))
    assert_equal("bg-conic", @merger.merge("bg-conic-10 bg-conic"))
    assert_equal("bg-conic/decreasing", @merger.merge("bg-radial bg-conic/decreasing"))
    assert_equal("bg-red-500 bg-conic", @merger.merge("bg-red-500 bg-conic"))
